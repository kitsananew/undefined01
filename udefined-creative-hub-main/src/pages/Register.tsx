...
const GOOGLE_SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbx5k5PpTON0ccpkLeRAD7V2Ir59kNPo0Ybtp6MniPFZLsUcTikzrg-QYZllDtuBnkJLhA/exec";
...
const registerSchema = z.object({
  studentName: z
    .string()
    .trim()
    .min(2, "กรุณากรอกชื่อ-นามสกุลนักเรียน")
    .max(100),
  ...
  studentAge: z
    ...
    .refine((v) => {
      const n = Number(v);
      return !Number.isNaN(n) && n >= 8 && n <= 20;
    }, "อายุต้องอยู่ระหว่าง 8-20 ปี"),

  school: z
    .string()
    .trim()
    .min(2, "กรุณากรอกชื่อโรงเรียน")
    .max(150),
...
const Register = () => {
  ...
  const onSubmit = async (data: RegisterForm) => {
    ...
    try {
      ...
      toast({
        title: "สมัครสำเร็จ!",
        description: "บันทึกข้อมูลลงระบบเรียบร้อยแล้ว",
      });
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="เช่น ม.2" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                    ...
                    <div className="space-y-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>
                              โรคประจำตัว / อาการแพ้ (ถ้ามี)
                            </FormLabel>
                            <FormControl>
                              <Input placeholder="ระบุถ้ามี" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
